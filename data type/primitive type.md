...
| :- | :- | :- | :- | :- |
| `byte` | 1 Byte | `-2^(8-1) ~ 2^(8-1)-1` | `-128 ~ 127` | +`123 ` +`-125`|
| `short` | 2 Byte | `-2^(16-1) ~ 2^(16-1)-1` | `-32,768 ~ 32,767` | +`235` +`-367`|
| `int` | 4 Byte | `-2^(32-1) ~ 2^(32-1)-1` | `-2,147,483,648 ~ 2,147,483,647` | +`214,748,364` +`-2,147,483,646`|
